...
https://www.yuque.com/u21195183/hfcamg/mpbhe9(完整20220926)
[toc]
...
- `content-box `默认值，宽度和高度用来设置内容区的大小
  ...
  ![image-20210523192824864](img\c5c64fe3-dbec-40c2-9b38-32114a9302d3.png)

- `border-box` 宽度和高度用来设置整个盒子可见框的大小

  ![image-20210523192847224](img\d5508dac-8a3e-47ce-9bc8-65150c9dec33.png)
...
![image-20210523193426492](img\b02873d3-5551-4028-b234-668b421614fe.png)
...
![image-20210523193328096](img\be1213f1-460f-43b6-8134-1f3537632932.png)
...
![动画2021-47](img\a627b171-2e78-436a-a8f2-a89fe9101c89.gif)
...
![image-20210523200019261](img\3787a000-e839-4cb2-ab9e-53aebf66128f.png)

```css
box-shadow: 10px 10px 5px orange;
```

![image-20210523200055142](img\fbf509c1-1bf4-4ce8-937b-050456d5ab15.png)

```css
box-shadow: 10px 10px 5px rgba(0, 0, 0, 0.2);
```

![image-20210523200335892](img\e2cbdc03-80fb-413f-811f-02a48471b91e.png)
...
![image-20210523200759864](img\928dabb7-1a84-4f42-8ee3-017cb3f9f7cc.png)

```css
border-top-right-radius: 50px 100px;
```

![image-20210523201042444](img\76d2495f-e61f-4471-b9bb-acd7af6a0c0a.png)
...
![image-20210523201706646](img\32001073-3d75-473e-8dd9-0b353f7fe3ed.png)
...
![image-20210523202031227](img\d583d925-0fbd-4544-b611-6b9b75fac199.png)
...
![image-20210523215905634](img\ad89f67e-afe8-49d0-962e-a1ba00076218.png)
...
![image-20210525004852198](img\7b7ed631-ed83-46c5-b572-4bdef4d293fa.png)
