...
- <mark>name</mark> ：指定的数据的名称
  ...
  - <mark>description</mark>：表示网站的描述信息
    ...
    ![image-20210514230338273](img\742d4008-37f8-4343-b9d4-840fe3e871ba.png)

- <mark>content</mark> ：指定的数据的内容，会作为搜索结果的超链接上的文字显示

打开 Zeal 手册（前端开发准备中做过介绍）

![image-20210514230900103](img\45a20c03-76e2-4b61-aac5-25526814a8a9.png)
...
![image-20210514231126506](img\32ca167b-41e4-4ae3-ac89-fedfc2887cfc.png)
...
![HTML5 语义元素](img\3a4f1e88-3de5-45cf-8306-15d6adcdcffa.png)
...
- 有序列表，使用`ol`标签来创建有序列表，使用`li`表示列表项
  ...
  ![image-20210515212835770](img\761b075e-2f87-41d9-8113-9d60d9e18af4.png)
...
- 无序列表，使用`ul`标签来创建无序列表，使用`li`表示列表项
  ...
  ![image-20210515213301387](img\0640ccfb-e606-4384-91f4-da3217eea545.png)
...
- 定义列表，使用`dl`标签来创建定义列表，使用`dt`表示定义的内容，使用`dd`来对内容进行解释说明
  ...
  ![image-20210515212936773](img\5c99e087-2dc5-4746-89ff-07adb1833619.png)
...
![image-20210515233449533](img\44cdfe96-fc09-4612-a0c7-1790d6fa9b16.png)
...
![image-20210516001417802](img\df2c6508-5070-4442-ae50-e7ee8be08c3c.png)
...
![image-20210516002915651](img\10a05a24-05fb-4764-a73c-7693c213cb3d.png)
...
![image-20210516004453236](img\fd72786d-87f5-47a7-842e-f64cd3dcefa4.png)

IE8 下，出现我们自定义的提示信息

![image-20210516005054543](img\262f75c5-5ecc-44bb-8836-1a580f59d850.png)
...
![image-20210516005207428](img\381e8ea4-8425-4b91-8f59-771f094595fc.png)
...
![image-20210516012905334](img\f1e3c181-d9df-4a7c-aa9e-a7fd1cd2a7a8.png)

IE8 下，也能正常播放

![image-20210516010618514](img\552a7778-b486-4f37-9995-00cac2d10748.png)

### 其他

通过`iframe`和`embed`的方式引入视频。以某艺为例，提供了视频链接的 HTML 代码和通用代码

![image-20210516011905816](img\5415d6d2-6df2-43c0-90a5-35294a3a3eb1.png)

![image-20210516011837229](img\cc3278d5-8563-49ef-bcc3-2467ab90bead.png)
