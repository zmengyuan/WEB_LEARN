...
class App {
  ...
  _renderWorkoutMarker(workout) {
    L.marker(workout.coords)
      ...
      .setPopupContent(
        `${workout.type === 'running' ? '馃弮鈥嶁檪锔?' : '馃毚鈥嶁檧锔?'} ${
          workout.description
        }`
      )
      .openPopup();
  ...
  _renderWorkout(workout) {
      ...
      <li class="workout workout--${workout.type}" data-id="${workout.id}">
        ...
        <div class="workout__details">
          <span class="workout__icon">${
            workout.type === 'running' ? 'running' : 'cycle'
          }</span>
          <span class="workout__value">${workout.distance}</span>
          <span class="workout__unit">km</span>
        </div>
        <div class="workout__details">
          <span class="workout__icon">3</span>
    ...
    if (workout.type === 'running')
      html += `
        <div class="workout__details">
          <span class="workout__icon">r</span>
          <span class="workout__value">${workout.pace.toFixed(1)}</span>
          <span class="workout__unit">min/km</span>
        </div>
        <div class="workout__details">
          <span class="workout__icon">d</span>
    ...
    if (workout.type === 'cycling')
      html += `
        <div class="workout__details">
          <span class="workout__icon">1</span>
          <span class="workout__value">${workout.speed.toFixed(1)}</span>
          <span class="workout__unit">km/h</span>
        </div>
        <div class="workout__details">
          <span class="workout__icon">2</span>
