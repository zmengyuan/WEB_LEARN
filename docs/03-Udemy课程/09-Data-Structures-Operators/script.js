...
/* 
We're building a football betting app (soccer for my American friends 馃槄)!
...
for (const [key, value] of gameEvents) {
  if (key <= 45) {
    ...
    console.log(`[After Half] ${key}: ${value}`);
  }
}
*/
/*
...
const checkMiddleSeat = function (seat) {
  ...
  if (s === 'B' || s === 'E') console.log('You got the middle seat 馃槵');
  else console.log('You got lucky 馃槑');
};
...
const planesInLine = function (n) {
  console.log(`There are ${n} planes in line ${'馃洨'.repeat(n)}`);
};
planesInLine(5);
planesInLine(3);
planesInLine(12);